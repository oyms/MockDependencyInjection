...
public static class FixtureExtensions
{
    ...
    /// </summary>
    /// <remarks>
    /// The <paramref name="serviceProvider"/> is wrapped in a <see cref="IServiceProvider"/>
    /// and sent to <see cref="Fixture{T,TFixture}.Use"/>.
    /// </remarks>
    public static TFixture Use<T, TFixture>(this Fixture<T, 
            TFixture> fixture, 
            IServiceProvider serviceProvider) where T : class where TFixture : Fixture<T, TFixture>
    {
        fixture.Use(new ServiceProviderWrapper(serviceProvider));
